  ...
  <div class="pt-5">
    <div class="container pt-lg-5">
      <div class="row mb-5 align-items-center">
        <div class="col-auto">
          <img src="{{ asset('web/images/footLogo.svg') }}" alt="" />
        </div>
        <div class="col">
      ...
      <div class="row gx-lg-5 justify-content-between">
        ...
        <div class="col-md-4 mb-4 mb-md-0">
          <div class="text-center mx-auto footBox">
            ...
            {{-- <a href="#" class="d-table mx-auto ctaBtn">{{ __('web.partnerPortal') }}</a> --}}
            <ul class="row gx-3 justify-content-center mt-4 footSocial">
              <li class="col-auto">
