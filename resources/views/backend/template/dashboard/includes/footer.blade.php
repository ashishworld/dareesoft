...
<script src="{{ asset('backend/vendor/js/media-library.js') }}"></script>
@endif

@if (isset($isListPage) && $isListPage)
<script src="https://cdn.datatables.net/1.13.1/js/jquery.dataTables.min.js"></script>
<script src="{{ asset('backend/vendor/js/table.js') }}"></script>
...
<script src="{{ asset('backend/vendor/js/form-addons.js') }}"></script>
@endif
...
<script src="{{ asset('backend/vendor/js/'.$customScriptName.'.js') }}"></script>
@endif